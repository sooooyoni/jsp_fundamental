...
<!-- map start -->
<div id="map" style="width: 95%; height: 550px; margin:3%"></div>
...
<!-- map end -->
	...
	<button type="button" class="btn btn-success"><a class="button" href="program.jsp" role="button" style="color: white">뒤로 가기</a></button>
	</div>
